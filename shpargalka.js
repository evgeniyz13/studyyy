...
// 4) Ручная привязка This (call, apply, bind)
  ...
  const objjj = {
    num: 5,
    sayNumber: function(){ //у метода контекст =  сам обьект в котором содержитсья этот метод
      const say = () => { // так как у стрелочной ф-и нет своего контекста вызова она ссылаеться на родителся
